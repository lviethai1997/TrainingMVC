...
namespace Training.Service.Common
{
    public static class PrintBillExcel
    {
        ...
        public static async Task<byte[]> ExportExcel(OrderDetailView dataview, string filepath)
        {
            ...
            using (var package = new ExcelPackage(new FileInfo(filepath)))
            {
                ...
                var tableRange = ws.Cells["A10"].LoadFromCollection(dataview.ListProducts,false, OfficeOpenXml.Table.TableStyles.Dark1);
